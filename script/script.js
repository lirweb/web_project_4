...
const submitAddCard= document.querySelector(".button_type_submit");

buttonAddCard.addEventListener("click", () => {openPopup(popupAddCard), submitAddCard.classList.add(inactiveButtonClass) });
