import { resetForm, settings, checkInitialFormValidity } from "./validate.js";
...
buttonEdit.addEventListener("click", () => {
    ...
    checkInitialFormValidity(popupEditProfile.querySelector("form"), settings);
});
...
function renderCardElement(card) {
    cards.prepend(createCardElement(card));
}
...
initialCards.forEach((initialCardData) => renderCardElement(initialCardData));
...
const addCardFormElement = document.querySelector(".popup__box-addCard");
buttonAddCard.addEventListener("click", handleAddButton);
function handleAddButton() {
    resetForm(addCardFormElement, settings);
