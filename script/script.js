...
popupEditProfile.addEventListener("click, () =>{
        ...
        buttonAddProfile.addEventListener("click", function() { openPopup(popupAddCard) }); popupEditProfile.addEventListener("submit", submitForm);
        ...
        const allCloseButtons = document.querySelectorAll(".button_type_exit"); allCloseButtons.forEach(btn => btn.addEventListener("click", () => {
